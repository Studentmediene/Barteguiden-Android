...
public class EventsItem {
    ...
    private String showDate = "";   // date witch would show to user,  some events have period and because
    // of this we must some times calculate date witch we want to show
    ...
    public boolean getIsGeo() {
        if (this.getGeoLatitude() < 200.0f) return true;
        else return false;
    }
